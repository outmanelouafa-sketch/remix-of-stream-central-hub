...
const ContactSection = () => {
  ...
  const whatsappUrl = `https://wa.me/${settings?.whatsapp_number}?text=Hello!%20I%20am%20interested%20in%20your%20IPTV%20subscription.`;
  const telegramUrl = `https://t.me/${settings?.telegram_id}`;
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
                ...
                <span className="ml-auto text-xs px-3 py-1 rounded-full bg-whatsapp/20 text-whatsapp font-medium">Online</span>
              </a>
              ...
              <a href={telegramUrl} target="_blank" rel="noopener noreferrer"
                ...
                <span className="ml-auto text-xs px-3 py-1 rounded-full bg-telegram/20 text-telegram font-medium">24/7</span>
              </a>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} maxLength={100} placeholder="John Doe"
                ...
                <div>
                  ...
                  <input type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} maxLength={255} placeholder="john@example.com"
                    className="w-full px-4 py-3 rounded-xl bg-surface border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" />
                ...
                <div>
                  ...
                  <textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} maxLength={1000} rows={5} placeholder="Tell us how we can help..."
                ...
                <button type="submit" className="btn-cta w-full py-4 rounded-xl font-bold text-sm shadow-lg shadow-primary/20">Send Message</button>
              </form>
            )}
          </div>
        </div>
